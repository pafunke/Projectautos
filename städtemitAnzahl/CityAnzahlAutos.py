    ...
    fig.add_trace(go.Scattermapbox(
        ...
        marker=go.scattermapbox.Marker(
            ...
            colorbar= dict(
                ...
                tickvals=[0, 10000, 20000, 30000],  # Positionen der Tickmarken auf der Farbskala
                ticktext=["0", "30000"],  # Beschriftungen der Tickmarken auf der Farbskala
                x=1.2  # Position der Farbskala auf der Karte
